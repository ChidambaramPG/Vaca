...
class SingleFlightReturn extends Component {
    ...
    render() {
        ...
        return (
            <Grid style={styles.individualFlightContainer} elevation={2} >
                ...
                <Row size={25}>
                    <FlightBasicInfo image={this.props.flight.route[1].airline} number={this.props.flight.route[1].flight_no} />
                </Row>
                    ...
                    <Grid style={styles.firstRowContainer}>
                        <Col>
                            <Grid style={styles.firstRowFromContainer}>
                                ...
                                <Row>
                                    <Text style={styles.airportLeftText}>{this.props.flight.route[1].flyFrom}</Text>
                                </Row>
                                <Row>
                                    <Text style={styles.timeLeftText}>{this.convertToTimeString(this.props.flight.route[1].dTime)}</Text>
                                </Row>
                            </Grid>
                        </Col>
                        <Col>
                            <Grid style={styles.firstRowFromContainer}>
                                ...
                                <Row>
                                    <Text>{this.props.flight.return_duration}</Text>
                                </Row>
                                <Row>
                                    <Text>non-stop</Text>
                                </Row>
                        ...
                        <Col>
                            <Grid style={styles.firstRowFromContainer}>
                                <Row>
                                    <Text style={styles.airportRightText}>{this.props.flight.route[1].flyTo}</Text>
                                </Row>
                                <Row>
                                    <Text style={styles.timeRightText}>{this.convertToTimeString(this.props.flight.route[1].aTime)}</Text>
                                </Row>
                            </Grid>
                        </Col>
                    </Grid>
...
export default connect(mapStateToProps, mapDispatchToProps)(SingleFlightReturn);
